//
//  TextOptionsTableViewController.swift
//  DrinkAPP
//
...
class TextOptionsTableViewController: UITableViewController {
...
//    }
    ...
    @IBAction func optionsButtonClicked(_ sender: UIButton) {
        ...
        if let indexPath = iceTableView.indexPathForRow(at: point) {
            ...
            if indexPath[0] == 0, (iceTableView.numberOfRows(inSection: 0) != 0) {
